...
class AgentGestFrontend:
    def __init__(self, parent_frame, curseur):
        ...
        self.AdresseEnt.place(x=500, y=150, width=150, height=30)
        ...
        self.EnfantsEnt.place(x=200, y=190, width=190, height=30)
        ...
        self.Supprimer_btn.place(x=510, y=270, width=100, height=30)
                ...
                # Section du tableau
        self.TabSection = tk.Frame(self.AgentSection, height=550, width=740, relief="groove")
        ...
        self.tableau = ttk.Treeview(self.TabSection, columns=('Nom', 'Sexe', 'Date Naissance', 'Lieu Naissance', 'Etat Civil', 'Adresse', 'Enfants'), 
    ...
    def ajouter_agent(self):
        ...
        self.tableau.insert('', 'end', values=(nom, sexe, date_naissance, lieu_naissance, etat_civil, adresse, enfants))
...
# Appliquer un style personnalisé pour les barres de défilement
#style = ttk.Style()
#style.configure("TScrollbar", background="#27B795", troughcolor="#D3D3D3", bordercolor="#FFFFFF", arrowcolor="#FFFFFF")

app = AgentGestFrontend(root, None)
root.mainloop()
